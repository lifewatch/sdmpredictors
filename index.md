...
An R package to improve the usability of datasets with predictors for
...
Example 1: Create SDM for Dictyota diemensis in Australia Note that this
requires the *ZOON*, *ggplot2*, *cowplot* and *marinespeed* packages to
be installed.
...
Example 3: looking up statistics and correlations for marine annual
layers:
